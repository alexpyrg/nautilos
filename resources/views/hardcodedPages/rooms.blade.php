...
{{--    <link rel="stylesheet" href="{{ asset('css/new_styles.min.css') }}" />--}}
    ...
    @livewireScripts
    @livewireStyles
    <title>Double room In Cretan Villa hotel in Ierapetra Crete. Best Ierapetra Hotels. solo travel crete</title>
</head>
<body>
<livewire:top-bar />
<livewire:menu-bar/>
...
<div class="room-content">
    <h1 class="animated-title"> Double/Twin Room </h1>
    ...
    <p class="description-paragraph">
        ...
        Double room in Cretan Villa hotel.

        The width of the double rooms is between 18 to 20 square meters with either a double bed or with 2 single beds.
        <br>
        Perfect solution for a couple or group 2 friends.
        <br>
        For the comfort of our guests all the rooms are equipped with ensuite bathroom, individual air condition, fridge, mini bar, satellite T.V & free wireless internet access.

        A Double Room has either a double bed or 2 single beds. <br>You can specify your bedding preference in the ‘Special Requests’ box during the booking process.

        Holiday makers will enjoy the romantic and cozy atmosphere of these great value for money double or twin rooms. They are very comfortable, clean and quiet.
        <br>
    ...
    <br>
        Do you prefer to request information via email? Do you have particular needs that our on line booking system can not satisfy?
        <br>
...
{{--                        <img src="{{ asset('images/double-room-bed-showcase.jpg') }}"  alt="Double room bed">--}}
{{--                    </li>--}}
{{--                    <li class="splide__slide">--}}
{{--                        <img src="{{ asset('images/double-room-bath-showcase-2.jpg') }}" alt="Double room bath">--}}
{{--                    </li>--}}
{{--                    <li class="splide__slide">--}}
{{--                        <img src="{{ asset('images/double-room-showcase-3.jpg') }}" alt="Double room nice beds">--}}
{{--                    </li>--}}
{{--                    <li class="splide__slide">--}}
{{--                        <img src="{{ asset('images/double-room-showcase-4.jpg') }}" alt="Double asdasd">--}}
{{--                    </li>--}}
{{--                    <li class="splide__slide">--}}
{{--                        <img src="{{ asset('images/double-room-showcase-5.jpg') }}" alt="Double asdasd">--}}
{{--                    </li>--}}
{{--                    <li class="splide__slide">--}}
{{--                        <img src="{{ asset('images/double-room-showcase-6.jpg') }}" alt="Double asdasd">--}}
{{--                    </li>--}}
{{--                    <li class="splide__slide">--}}
{{--                        <img src="{{ asset('images/double-room-showcase-7.jpg') }}" alt="Double asdasd">--}}
{{--                    </li>--}}
{{--                    <li class="splide__slide">--}}
{{--                        <img src="{{ asset('images/double-room-showcase-8.jpg') }}" alt="Double asdasd">--}}
{{--                    </li>--}}
{{--                </ul>--}}
{{--            </div>--}}
{{--        </section>--}}
...
{{--        </section>--}}
        ...
        <div class="room-pictures-gallery">
            ...
            <img data-fancybox="gallery" src="{{ asset('images/double-room-bed-showcase.jpg') }}">
            <img data-fancybox="gallery" src="{{ asset('images/double-room-bath-showcase-2.jpg') }}">
            <img data-fancybox="gallery" src="{{ asset('images/double-room-showcase-3.jpg') }}">
            <img data-fancybox="gallery" src="{{ asset('images/double-room-showcase-4.jpg') }}">
            <img data-fancybox="gallery" src="{{ asset('images/double-room-showcase-5.jpg') }}">
            <img data-fancybox="gallery" src="{{ asset('images/double-room-showcase-6.jpg') }}">
            <img data-fancybox="gallery" src="{{ asset('images/double-room-showcase-7.jpg') }}">
        </div>
