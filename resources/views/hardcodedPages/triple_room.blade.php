...
<div class="room-content">
    <h1 class="animated-title"> Triple room</h1>
    ...
    <p class="description-paragraph">
        ...
        Triple room in Cretan Villa .

        The width of the triple rooms is  between 20 to 24 square meters with a double and a single bed or with 3 single beds.
        <br>
        Perfect solution for small family or group of friends.
        <br>
