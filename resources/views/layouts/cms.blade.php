...
{{--    <script src="--}}
{{--https://cdn.jsdelivr.net/npm/tailwindcss@3.4.14/lib/index.min.js--}}
{{--"></script>--}}
{{--    <link href="--}}
{{--https://cdn.jsdelivr.net/npm/tailwindcss@3.4.14/base.min.css--}}
{{--" rel="stylesheet">--}}
...
<script src="{{ asset('js/menuToggles.js')}}"></script>
...
-->
    <script>
        ...
        window.onload = function() {
            const buttons = document.querySelectorAll('.show_sub_pages_button');
