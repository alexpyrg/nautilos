<div>
  {{--
   NOT USED YET NOT USED YET NOT USED YET NOT USED YET NOT USED YET NOT USED YET NOT USED YET
   NOT USED YET NOT USED YET NOT USED YET NOT USED YET NOT USED YET NOT USED YET NOT USED YET
   NOT USED YET NOT USED YET NOT USED YET NOT USED YET NOT USED YET NOT USED YET NOT USED YET
   NOT USED YET NOT USED YET NOT USED YET NOT USED YET NOT USED YET NOT USED YET NOT USED YET
   NOT USED YET NOT USED YET NOT USED YET NOT USED YET NOT USED YET NOT USED YET NOT USED YET
  ...
  --}}
    <div class="wrapper">
        <div id="carousel" class="carousel">
            <div class="slide">
                ...
                <picture>
                    <img decoding="async" loading="lazy" src="{{ asset('images/dimos-ierapetras-top.jpg') }}" alt="less-rain-dummy-01">
                </picture>
            </div>
            <div class="slide"> <h2>with a view to the Libyan Sea and its myths</h2>
                <img decoding="async" src="{{ asset('images/ierapetra_n2.jpg') }}" alt="less-rain-dummy-02"></div>
            <div class="slide"> <h2>where you lose yourself in the picturesque narrow streets of the old town</h2 >
                <img decoding="async" src="{{ asset('images/saint_george.jpg') }}" alt="less-rain-dummy-03"></div>
            <div class="slide">
                <h2>wish you were here</h2>
                <img src="{{ asset('images/4_cropped.jpg') }}" decoding="async" alt="less-rain-dummy-04"></div>
    ...
    <div class="divider-lg">
        ...
        <div class="button-group" >
            <a class="button" href="/en/excursions-sightseeing"> Places to see </a>
            <a class="button" href="/en/crete-sports-activities"> Things to do </a>
            <a class="button" href="/en/ierapetra-crete-beaches"> Beaches </a>
            <a class="button" href="/en/ierapetra-crete-chrissi-island"> Chrissi Island </a>
            <a class="weatherwidget-io max-350 nc" href="https://forecast7.com/en/35d0125d74/ierapetra/" data-label_1="IERAPETRA" data-label_2="WEATHER" data-icons="Climacons Animated" data-mode="Current" data-theme="original" data-basecolor="#9D968D" >IERAPETRA WEATHER</a>
            <script>
                !function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='https://weatherwidget.io/js/widget.min.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','weatherwidget-io-js');
            </script>
            {{--            <div class="weather" id="cont_7b765f37f46d48eb83c3589d6b15df01"><script type="text/javascript" async src="https://www.yourweather.co.uk/wid_loader/7b765f37f46d48eb83c3589d6b15df01"></script></div>--}}
        </div>
    ...
    <div class="locations-container">
        <h1 class="animated-title" style="padding-left: 0; font-family: Geometria-Light; font-size: 36px;">
            Holidays in Ierapetra Crete. A visitor's guide to Ierapetra city.
        </h1>
        <p>Ierapetra is built on the longest beach in Crete and it has the reputation of been the southernmost town in Europe. It has the largest population in Lasithi and is the fourth largest town in Crete. The temperature rarely drops below 13 C all year long,and it has the most hours of sunshine and lowest rainfall in Greece. Ierapetra has much to offer its visitors: Sandy beaches, rocky mountains, a unique fauna, excellent food – the world famous Cretan cuisine, significant archaeological and natural beauties.</p>

        <div class="location">
            <h2>The Archaelogical Collection</h2>
            <img src="{{ asset('images/ierapetra-museum.jpg') }}" alt="ierapetra museum">
            <p>
        ...
        <div class="location">
            <h2>Kales</h2>
            <img src="{{ asset('images/kales-ierapetra.jpg') }}" alt="ierapetra kales fortress, castle of kales">
            <p>
        ...
        <div class="location">
            <h2>The Cathedral of St. Georgios</h2>
            <img src="{{ asset('images/agio-georgios.jpg') }}" alt="ierapetra st. georgios">
            <p>
        ...
        <div class="location">
            <h2>The Napoleon's residence</h2>
            <img src="{{ asset('images/ierapetra-napoleon-house.jpg') }}" alt="ierapetra napoleons residence, napoleon's house ierapetra">
            <p>
        ...
        <div class="location">
            <h2>Afentis Christos</h2>
            <img src="{{ asset('images/ierapetra-afentis-hristos.jpg') }}" alt="ierapetra museum">
            <p>
        ...
        <div class="location">
            <h2>Moslem monuments</h2>
            <img src="{{ asset('images/ierapetra-turkish-buildings.jpg') }}" alt="ierapetra muslim">
            <p>
